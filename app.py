...
Tops = Frame(root, width=1250, height=80, bd=12, relief="raise")
Tops.pack(side=TOP)
...
lblInfo = Label(Tops, font=('arial', 64, 'bold'), text="Restaurant App", bd=9)
...
def CostofItems():
    ...
    DrinksandCakesPrice = "$"+ str("%.2f" % PriceofCakesandDrinks)
    ...
    SubTotalofITEMS = "$ "+ str(round(PriceofFood + PriceofCakesandDrinks + 0.15))
    SubTotal.set(SubTotalofITEMS)

    Tax = "$ "+ str(round((PriceofFood + PriceofCakesandDrinks + 0.15)*0.05))
    PaidTax.set(Tax)
    TT = ((PriceofFood + PriceofCakesandDrinks + 0.15)*0.05)
    TC = "$ "+ str(round((PriceofFood + PriceofCakesandDrinks + 0.15) + TT))
    print((TC))
    TotalCost.set(TC)
...
Fries = Checkbutton(f1aa, font=('arial',18, 'bold'), text="Fries", variable=var1, onvalue=1,
                    offvalue=0, command=chkbutton_value).grid(row=0, sticky=W)

Lunch = Checkbutton(f1aa, font=('arial', 18, 'bold'), text="Lunch", variable=var2, onvalue=1,
                       offvalue=0, command=chkbutton_value).grid(row=1, sticky=W)

Burger = Checkbutton(f1aa, font=('arial', 18, 'bold'), text="Burger", variable=var3, onvalue=1,
                         offvalue=0, command=chkbutton_value).grid(row=2, sticky=W)

Pizza = Checkbutton(f1aa, font=('arial', 18, 'bold'), text="Pizza", variable=var4, onvalue=1,
                          offvalue=0, command=chkbutton_value).grid(row=3, sticky=W)

CheeseBurger = Checkbutton(f1aa, font=('arial', 18, 'bold'), text="Ice Cream", variable=var5, onvalue=1,
...
MacPuff = Checkbutton(f1aa, font=('arial', 18, 'bold'), text="Meat Pie \t", variable=var7, onvalue=1,
...
Latta = Checkbutton(f1ab, font=('arial', 18, 'bold'), text="Wine \t", variable=var13,
